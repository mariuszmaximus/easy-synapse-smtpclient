...

{
  ...
  Sample usage:
    ...
    More docs and code:
      ...
      http://www.indyproject.org/Sockets/Blogs/RLebeau/2005_08_17_A.en.aspx = attachments 'theory'
...
begin
  ...
  if ( BodyAsPlainText.Count > 0 ) or
     ( ( BodyAsPlainText.Count = 0 ) and ( BodyAsHtml.Count = 0 ) ) then
    // if no body at all then still add this to prevent invalidation of all message parts
